...
### Step 3.8: Embedding Integration
...
### Step 3.9: Qdrant Vector DB Integration
...
### Step 3.10: The Unified Ingestion Pipeline
- **Goal:** Orchestrate the full "Extract -> Clean -> Chunk -> Embed -> Store" flow.
- **Implementation:** Update `core/processor.py` or create a new `IngestionPipeline` orchestrator.
